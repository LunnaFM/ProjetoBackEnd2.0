          ...
          <div className="form-card">
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label>Quarto <span className="required">*</span></label>
                  <select
                    name="quartoId"
                ...
                <div className="form-group">
                  <label>Data Check-in <span className="required">*</span></label>
                  <input
                    type="date"
                    name="dataCheckIn"
                ...
                <div className="form-group">
                  <label>Data Check-out <span className="required">*</span></label>
                  <input
                    type="date"
                    name="dataCheckOut"
                ...
                <tbody>
                  {reservas.map((reserva) => (
                    <tr key={reserva.id}>
                      ...
                      <td>
                        <span className={getStatusBadge(reserva.status)}>
                          {reserva.status}
                        </span>
                      </td>
                      <td className="actions">
                        ...
                        {reserva.status !== 'cancelada' && (
                          <button
                            ...
                            title="Cancelar"
                          >
                            <XCircle size={20} color="#f59e0b" strokeWidth={2} />
                          </button>
                        )}
                        <button
