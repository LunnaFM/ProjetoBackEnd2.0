...
import { Bed, Sparkles, Crown, Edit, Trash2 } from 'lucide-react';
import './Pages.css';
...
const Quartos = () => {
  ...
  const getTipoIcon = (tipo) => {
    const iconProps = { size: 16, strokeWidth: 2, style: { display: 'inline', marginRight: '0.25rem', verticalAlign: 'middle' } };
    
    const icons = {
      solteiro: <Bed {...iconProps} color="#7c3aed" />,
      casal: <><Bed {...iconProps} color="#7c3aed" /><Bed {...iconProps} color="#7c3aed" /></>,
      luxo: <Sparkles {...iconProps} color="#f59e0b" />,
      suite: <Crown {...iconProps} color="#f59e0b" />
    };
    return icons[tipo] || <Bed {...iconProps} color="#7c3aed" />;
  };
    ...
    <Layout>
      <div className="page-container">
        <div className="page-header">
          <h1 className="page-title">Gerenciamento de Quartos</h1>
          <button
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                <div className="form-group">
                  <label>Número do Quarto <span className="required">*</span></label>
                  <input
                    type="text"
                    name="numero"
                ...
                <div className="form-group">
                  <label>Capacidade <span className="required">*</span></label>
                  <input
                    type="number"
                    name="capacidade"
                ...
                <div className="form-group">
                  <label>Valor da Diária (R$) <span className="required">*</span></label>
                  <input
                    type="number"
                    name="valorDiaria"
                ...
                <tbody>
                  {quartos.map((quarto) => (
                    <tr key={quarto.id}>
                      ...
                      <td>
                        <span className={getStatusBadge(quarto.status)}>
                          {quarto.status}
                        </span>
                      </td>
